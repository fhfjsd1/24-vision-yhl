...
data_path = "/home/taylor/testcpp/24-vision-yhl-1/classification-finished/data"  # todo 修改为数据集根目录
model_path = "/home/taylor/testcpp/24-vision-yhl-1/classification-finished/resnet50d_10epochs_accuracy1.00000_weights.pth"  # todo 模型地址
...
params = {
    ...
    "test_dir": osp.join(data_path, "validation"),  # todo 测试集子目录
    'device': device,  # 设备
    'batch_size': 4,  # 批次大小
    'num_workers': 0,  # 进程
...
def test(val_loader, model, params, class_names):
    ...
    show_heatmaps(title="heatmap", x_labels=class_names, y_labels=class_names, harvest=heat_maps_float,
                  save_name="/home/taylor/testcpp/24-vision-yhl-1/classification-finished/record/{}.png".format(model_name))
